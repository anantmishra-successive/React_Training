...
function PersonForm() {
  ...
  return (
    ...
    <div>
        ...
        <input className='fields' type="text" value={firstName} onChange={(e)=> setFirstName(e.target.value)} />
         </div>
       
<div>
<label htmlFor="lastname">Last Name</label>
        <input className='fields' type="text" value={lastName} onChange={(e)=> setLastName(e.target.value)} />
</div>
        
<div>
<label htmlFor="name">Age</label>
       &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<input className='fields' type="text" value={age} onChange={(e)=> setAge(e.target.value)} />
</div>
 ...
 {
    submit && <div> FirstName: {firstName} <br/> LastName: {lastName} <br/> Age: {age} </div>
 }
